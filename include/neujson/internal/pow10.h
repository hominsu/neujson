...
#ifndef NEUJSON_INCLUDE_NEUJSON_INTERNAL_POW10_H_
#define NEUJSON_INCLUDE_NEUJSON_INTERNAL_POW10_H_

#include "neujson/neujson.h"

namespace neujson::internal {

inline double Pow10(const int n) {
...
#endif // NEUJSON_INCLUDE_NEUJSON_INTERNAL_POW10_H_
